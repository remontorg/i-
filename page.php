...
<head>
	...
	<link rel="icon" href="<?php bloginfo('template_url'); ?>/i/favicon.ico">
	</link>
							<!-- webpjs -->
...
<body>
	...
	<div class="w100" id="callback">
		<div class="w1000">
			...
			<form method="POST" id="forms" action="<?php echo $_SERVER["REQUEST_URI"]; ?>" onsubmit="yaCounter36741230.reachGoal('ORDER'); gtag_report_conversion(); return true;">
	...
	<div class="w100" id="menu">
		<div class="w1000">
			<ul>
				<li><a href="<?php bloginfo('url'); ?>" class="" title="Вскрытие замков в Хабаровске"><img src="<?php bloginfo('template_url'); ?>/i/vskrytie-zamkov.png" title="Перекодировка замков" /><br />Перекодировка замков</a></li>
				<li><a href="<?php bloginfo('url'); ?>" class="" title="Вскрытие замков в Хабаровске"><img src="<?php bloginfo('template_url'); ?>/i/vskrytie-zamkov.png" title="Установка замков" /><br />Установка замков</a></li>
				<li><a href="<?php bloginfo('url'); ?>" class="" title="Вскрытие замков в Хабаровске"><img src="<?php bloginfo('template_url'); ?>/i/vskrytie-zamkov.png" title="Врезка замков" /><br />Врезка замков</a></li>
	...
	<div class="w100" id="contact">
		<div class="w1000">
			...
			<span id="free-master">Сейчас свободны<br /><b>3</b> из 5 мастеров</span>
		</div>
	</div>
	<h1 class="assosiation">
		<center><i>Хабаровская ассоциация вскрытия замков и дверей</i></center>
	</h1>
	...
	<div class="w100" id="how-it-work">
		<div class="w1000">
			<ul>
				<li><img src="<?php bloginfo('template_url'); ?>/i/Treatment_Plan-100.png" />
					<p>Позвоните нам и объясните диспетчеру вашу проблему</p>
				</li>
				<li><img src="<?php bloginfo('template_url'); ?>/i/Timer-100.png" />
					<p>Встречайте специалиста через 30-40 минут после вызова</p>
				</li>
				<li><img src="<?php bloginfo('template_url'); ?>/i/Security_Checked-100.png" />
...
<noscript>
	<div><img src="https://mc.yandex.ru/watch/92515961" style="position:absolute; left:-9999px;" alt="" /></div>
</noscript>
<!-- /Yandex.Metrika counter -->
<!-- HoverSignal -->
<script type="text/javascript">
